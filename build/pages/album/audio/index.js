...
exports.default = {
  ...
  setInfo: function setInfo(data) {
    ...
    data.play_count ? this.play_count = _util2.default.numW(data.play_count) : this.play_count = _util2.default.numW(_util2.default.randomNum(5000, 999999));
              ...
              return (0, _album.getAlbum)(this.album_id, this.page_no, this.page_size).then(function (res) {
                ...
                if (data.artilces.length) {
                  ...
                  list.forEach(function (v) {
                    v.duration = _util2.default.formatSeconds(v.audios[0].duration);
                  });
